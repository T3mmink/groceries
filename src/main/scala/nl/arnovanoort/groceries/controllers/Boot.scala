...
import nl.arnovanoort.groceries.domain.{GroceriesService}
...
class ControllerActor extends Actor with Routes with ActorLogging {
  def actorRefFactory = context
  val groceriesActor = actorRefFactory.actorOf(Props[GroceriesService], "groceries")
